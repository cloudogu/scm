...
### Added
- Added support for Dogu V3

## [3.11.10-1] 2026-06-10
### Changed
- Upgrade SCM-Manager to version 3.11.10 ([Changelog](https://github.com/scm-manager/scm-manager/blob/3.11.10/CHANGELOG.md))
...
### Changed
- Upgrade SCM-Manager to version 3.11.9 ([Changelog](https://github.com/scm-manager/scm-manager/blob/3.11.9/CHANGELOG.md))
 
## [3.11.8-1] 2026-04-08
### Changed
- Upgrade SCM-Manager to version 3.11.8 ([Changelog](https://github.com/scm-manager/scm-manager/blob/3.11.8/CHANGELOG.md))

## [3.11.7-1] - 2026-03-20
### Changed 
- Upgrade SCM-Manager to version 3.11.7 ([Changelog](https://github.com/scm-manager/scm-manager/blob/3.11.7/CHANGELOG.md))
...
## [3.11.5-2] 2026-03-13
### Changed
- Use proxy excludes from global config #115

## [3.11.5-1] 2026-02-25
### Changed
- Upgrade SCM-Manager to version 3.11.5 ([Changelog](https://github.com/scm-manager/scm-manager/blob/3.11.5/CHANGELOG.md))

## [3.11.4-3] 2026-02-18
### Fixed
- Upgrade base image to fix doguctl bug

## [3.11.4-2] 2026-02-12
### Fixed
- Upgrade base image to fix CVE-2025-61732 and CVE-2025-68121

## [3.11.4-1] 2026-02-11
### Changed
- Upgrade SCM-Manager to version 3.11.4 ([Changelog](https://github.com/scm-manager/scm-manager/blob/3.11.4/CHANGELOG.md))

## [3.11.3-1] 2026-02-10
### Changed
- Upgrade SCM-Manager to version 3.11.3 ([Changelog](https://github.com/scm-manager/scm-manager/blob/3.11.3/CHANGELOG.md))

## [3.11.2-2] 2026-02-03
### Fixed
- Upgrade Alpine base image to version 3.23.3 to fix CVE-2025-15467 and CVE-2026-24515

## [3.11.2-1] 2026-01-12
### Changed
- Upgrade SCM-Manager to version 3.11.2 ([Changelog](https://github.com/scm-manager/scm-manager/blob/3.11.2/CHANGELOG.md))

## [3.11.1-2] 2025-12-05
### Fixed
- Missing configuration of admin group if 'plugin_center_authentication_url' has been configured
- Configuration of gotenberg plugin if dogu is installed
- Applying configured log-level for script plugin

### Changed
- Removed configuration for 'plugin_center_authentication_url' (this is no longer available in SCM-Manager)

## [3.11.1-1] 2025-11-28
### Changed
- Upgrade SCM-Manager to version 3.11.1 ([Changelog](https://github.com/scm-manager/scm-manager/blob/3.11.1/CHANGELOG.md))

## [3.11.0-1] 2025-09-26
### Changed
- Upgrade SCM-Manager to version 3.11.0 ([Changelog](https://github.com/scm-manager/scm-manager/blob/3.11.0/CHANGELOG.md))

## [3.10.2-1] 2025-09-02
### Changed
- Upgrade SCM-Manager to version 3.10.2 ([Changelog](https://github.com/scm-manager/scm-manager/blob/3.10.2/CHANGELOG.md))

## [3.10.1-1] 2025-08-28
### Changed
- Upgrade SCM-Manager to version 3.10.1 ([Changelog](https://github.com/scm-manager/scm-manager/blob/3.10.1/CHANGELOG.md))

## [3.10.0-1] 2025-08-20
### Changed
- Upgrade SCM-Manager to version 3.10.0 ([Changelog](https://github.com/scm-manager/scm-manager/blob/3.10.0/CHANGELOG.md))

## [3.9.0-1] 2025-08-01
### Changed
- Upgrade SCM-Manager to version 3.9.0 ([Changelog](https://github.com/scm-manager/scm-manager/blob/3.9.0/CHANGELOG.md))

## [3.8.0-2] 2025-04-28
### Changed
- Set sensible resource requests and limits [#110]
...
## [3.7.8-1] 2026-02-25
### Changed
- Upgrade SCM-Manager to version 3.7.8 ([Changelog](https://github.com/scm-manager/scm-manager/blob/3.7.8/CHANGELOG.md))

## [3.7.7-2] 2026-02-03
### Fixed
- Upgrade Alpine base image to version 3.23.3 to fix CVE-2025-15467
...
## [3.7.3-1] 2025-02-25
### Changed
- Upgrade SCM-Manager to version 3.7.3 ([Changelog](https://github.com/scm-manager/scm-manager/blob/3.7.3/CHANGELOG.md))

## [3.7.1-2] 2025-02-12
### Removed
- Duplicate configuration keys from dogu.json [#104] 
