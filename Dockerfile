...
ENV SCM_HOME=/var/lib/scm \
    ...
    SCM_PKG_URL=https://maven.scm-manager.org/nexus/service/local/repositories/releases/content/sonia/scm/scm-server/2.0.0-rc3/scm-server-2.0.0-rc3-app.tar.gz
