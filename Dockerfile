...
ENV SCM_HOME=/var/lib/scm \
    ...
    SCM_PKG_URL=https://oss.cloudogu.com/jenkins/job/scm-manager/job/scm-manager-2.x/job/default/lastSuccessfulBuild/artifact/scm-server/target/scm-server-app.tar.gz
...
RUN set -x \
    ...
    && curl --fail -Lks https://oss.cloudogu.com/jenkins/job/scm-manager/job/plugins/job/scm-script-plugin/job/develop/lastSuccessfulBuild/artifact/target/scm-script-plugin-2.0.0-SNAPSHOT.smp -o ${SCM_REQUIRED_PLUGINS}/scm-script-plugin.smp \
    && curl --fail -Lks https://oss.cloudogu.com/jenkins/job/scm-manager/job/plugins/job/scm-cas-plugin/job/develop/lastSuccessfulBuild/artifact/target/scm-cas-plugin-2.0.0-SNAPSHOT.smp -o ${SCM_REQUIRED_PLUGINS}/scm-cas-plugin.smp \
    # cleanup
