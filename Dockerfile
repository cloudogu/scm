...
ENV SCM_HOME=/var/lib/scm \
    ...
    SCM_PKG_URL=https://maven.scm-manager.org/nexus/service/local/repositories/releases/content/sonia/scm/scm-server/2.0.0-rc5/scm-server-2.0.0-rc5-app.tar.gz
...
RUN set -x \
    ...
    && curl --fail -Lks https://oss.cloudogu.com/jenkins/job/scm-manager-plugins/job/scm-cas-plugin/view/tags/job/2.0.0-rc3/lastSuccessfulBuild/artifact/target/scm-cas-plugin-2.0.0-rc3.smp -o ${SCM_REQUIRED_PLUGINS}/scm-cas-plugin.smp \
    # cleanup
