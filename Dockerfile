...
ARG SCM_SCRIPT_PLUGIN_URL=https://packages.scm-manager.org/repository/plugin-releases/sonia/scm/plugins/scm-script-plugin/2.4.0/scm-script-plugin-2.5.0.smp
ARG SCM_SCRIPT_PLUGIN_SHA256=TODO
