...
* The Dogu now offers the SCM-Manager version 3.12.1.
...
* The Dogu now offers the SCM-Manager version 3.11.9.
* Fixes a critical CVE

## Release 3.11.7-1

* The Dogu now offers the SCM-Manager version 3.11.7.
...
* The Dogu now offers the SCM-Manager version 3.11.5.
...
* The Dogu now offers the SCM-Manager version 3.11.3.

## Release 3.11.2-2

* The Dogu is now based on Alpine 3.23.3 to fix CVE-2025-15467.

## Release 3.11.2-1

* The Dogu now offers the SCM-Manager version 3.11.2.

## Release 3.11.1-2

* Fixed missing configuration of admin group if 'plugin_center_authentication_url' has been configured.
* Fixed configuration of gotenberg plugin if dogu is installed.
* Fixed applying configured log-level for script plugin.
* Removed configuration for 'plugin_center_authentication_url'.

## Release 3.11.1-1

* The Dogu now offers the SCM-Manager version 3.11.1.

## Release 3.11.0-1

* The Dogu now offers the SCM-Manager version 3.11.0.
...
* The Dogu now offers the SCM-Manager version 3.7.8.
...
* The Dogu now offers the SCM-Manager version 3.7.7.
